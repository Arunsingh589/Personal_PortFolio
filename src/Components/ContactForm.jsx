...
const ContactForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length > 0) {
            ...
            emailjs
                .send(
                    "service_xk56gdi", // email code
                    "template_ftrq10o", //template code
                    formData,
                    "b_Go4viyNsEZ8YTlF" // public key
                )
                .then((response) => {
    ...
    return (
        <div className='p-4 lg:w-3/4' id='contact'>
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <div className='lg:w-1/2'>
                        <input type="text"
                            ...
                            className='mb-8 w-full appearance-none rounded-lg border
                             border-stone-50/30 bg-transparent px-3 py-2 text-sm focus:border-stone-400 focus:outline-none'
                        />
                        {
                            errors.name && (
                ...
                <button type='submit' className={`mb-8 w-full rounded border border-stone-50/30 bg-stone-200 px-4 py-2 text-sm font-semibold
